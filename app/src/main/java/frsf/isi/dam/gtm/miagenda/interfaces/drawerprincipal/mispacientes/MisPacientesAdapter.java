    ...
    public void onBindViewHolder(@NonNull PacienteHolder holder, int position) {
        holder.itemCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                i.putExtra("paciente", new Paciente("Intent ", "Ver paciente Btn", "Sancor Seguros", pruebaCalendario.getTime(), 40905, 3498415934L, "Argentina", "Santa fe","Escalada", "S/N", "493", "Sin dpto"));
